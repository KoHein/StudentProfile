                        ...
                        <div class="table-responsive">
                            <table class="table  text-center table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                    	<?php 
                                    		$studnet = User::where( 'id','=', $portfolio->studentid)->first();
                                    	 ?>
                                        <td>{{ $studnet->username }}</td>
                                        <td>{{ $portfolio->name }}</td>
                                        <td>{{ $portfolio->tools }}</td>
                                        <td>
                                        	{{ Link_to_route('home','Detail',  '#portfolio' , ['class' => 'btn btn-xs btn-success col-md-6'])}}

											{{Form::open(['method'=>'delete','action'=>['PortfolioController@deletePortfolio','id' => $portfolio->id]])}}
